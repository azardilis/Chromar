    ...
    in  { name = "chromar"
        ...
        , library =
          ...
          , when =
            [ { condition = "impl(ghc >= 8.10.0)"
              ...
              , other-modules = [ "Internal.RuleQuotes" ]
              }
        ...
        , tests =
          ...
          , germ =
            ...
            , other-modules = [ "SeedsModel.Env", "SeedsModel.Germ" ]
            , main = "germ.hs"
            , source-dirs = "models/seedsModel"
            , buildable = False
            }
          , utils =
            { dependencies =
              [ "base", "chromar", "text", "random", "normaldistribution" ]
            , other-modules = [ "SeedsModel.Env", "SeedsModel.Utils" ]
            , main = "utils.hs"
            , source-dirs = "models"
            , buildable = False
            }
